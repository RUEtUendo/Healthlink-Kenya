...
users = [
    models.User(name="Amara Ochieng", email="amara@healthlink.ke", hashed_password=pwd_context.hash("password123"), role="social_worker"),
    models.User(name="Joyce Mutua", email="joyce@healthlink.ke", hashed_password=pwd_context.hash("password123"), role="social_worker"),
    models.User(name="David Muriithi", email="david@healthlink.ke", hashed_password=pwd_context.hash("password123"), role="social_worker"),
    models.User(name="Faith Wanjiku", email="faith@healthlink.ke", hashed_password=pwd_context.hash("password123"), role="social_worker"),
    models.User(name="James Kipkemboi", email="james@healthlink.ke", hashed_password=pwd_context.hash("password123"), role="social_worker"),
    models.User(name="Rose Kimani", email="rose@healthlink.ke", hashed_password=pwd_context.hash("password123"), role="social_worker"),
    models.User(name="Supervisor Admin", email="admin@healthlink.ke", hashed_password=pwd_context.hash("admin123"), role="supervisor"),
]
db.add_all(users)
db.commit()
...
db.commit()
db.close()
print("✅ Database seeded with all 30 patients!")